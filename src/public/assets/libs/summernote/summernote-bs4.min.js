...
!(function (t, e) {
    ...
    function K(t) {
        return (
            !M(t) && t && /^DIV|^P|^LI|^H[1-7]/.test(t.nodeName.toUpperCase())
        );
    }
    var W = O('PRE'),
        q = O('LI');
    ...
    function bt(t, e) {
        ...
        if (0 === t.offset) {
            ...
            n = vt(t.node)
                ? nt((o = t.node.childNodes[t.offset - 1]))
    ...
    function yt(t, e) {
        ...
        if (nt(t.node) === t.offset) {
            ...
            n = vt(t.node)
                ...
                : ((o = t.node), e ? nt(t.node) : t.offset + 1);
        return { node: o, offset: n };
    }
    function kt(t, e) {
    ...
    function Ct(t, e) {
        ...
        return (
            dt(s, lt(r)),
            o || (rt(t.node), rt(s)),
            i && (it(t.node) && St(t.node), it(s))
                ? (St(s), t.node.nextSibling)
                : s
        );
    }
    function wt(t, o, n) {
    ...
    function Rt(t) {
        var s = function (t, e) {
                ...
                if ($t.isText(t)) {
                    ...
                    if (((o = t.childNodes[e] || t), $t.isText(o)))
                        return s(o, 0);
                    (e = 0), (n = !1);
                }
        ...
        summernote: function () {
            ...
            (i.langInfo = C.extend(
                ...
                (i.icons = C.extend(
                    !0,
                    {},
                    C.summernote.options.icons,
                    i.icons,
                )),
                (i.tooltip =
                    'auto' === i.tooltip ? !R.isSupportTouch : i.tooltip),
    ...
    var Lt = (function () {
            ...
            return (
                (r.prototype.nativeRange = function () {
                    ...
                    return (
                        e.setEndPoint(
                            'EndToEnd',
                            Rt({ node: this.ec, offset: this.eo }),
                        ),
                        e
                    );
                }),
                ...
                (r.prototype.wrapBodyInlineWithPara = function () {
                    ...
                    var t,
                        e = this.normalize();
                    if ($t.isParaInline(this.sc) || $t.isPara(this.sc))
                        return e;
                    if ($t.isInline(e.sc)) {
                    ...
                    if (
                        (n = n.concat(
                            $t.listNext(t.nextSibling, $t.isParaInline),
                        )).length
                    ) {
        ...
        At = {
            ...
            createFromNode: function (t) {
                ...
                return (
                    $t.isVoid(e) &&
                        ((o = $t.listPrev(e).length - 1), (e = e.parentNode)),
                    $t.isBR(n)
                        ? ((i = $t.listPrev(n).length - 1), (n = n.parentNode))
                        : $t.isVoid(n) &&
                          ((i = $t.listPrev(n).length), (n = n.parentNode)),
                    this.create(e, o, n, i)
                );
            },
        ...
        Dt = (function () {
            ...
            return (
                ...
                (t.prototype.stylePara = function (t, o) {
                    C.each(
                        t.nodes($t.isPara, { includeAncestor: !0 }),
                        function (t, e) {
                            C(e).css(o);
                        },
                    );
                ...
                (t.prototype.styleNodes = function (t, e) {
                    ...
                    var r = $t.makePredByNodeName(o),
                        s = t
                            .nodes($t.isText, { fullyContains: !0 })
                            .map(function (t) {
                                return (
                                    $t.singleChildAncestor(t, r) ||
                                    $t.wrap(t, o)
                                );
                            });
                    if (n) {
                        ...
                        return s.map(function (t) {
                            ...
                            return (
                                C.each(n, function (t, e) {
                                    $t.appendChildNodes(o, e.childNodes),
                                        $t.remove(e);
                                }),
                                B.head(e)
                            );
                ...
                (t.prototype.current = function (t) {
                    ...
                    return (
                        (o.anchor =
                            t.isOnAnchor() && $t.ancestor(t.sc, $t.isAnchor)),
            ...
            return (
                ...
                (t.prototype.wrapList = function (t, e) {
                    ...
                    return (
                        ...
                        r &&
                            ($t.appendChildNodes(s, B.from(r.childNodes)),
                            $t.remove(r)),
                        t
                    );
                }),
                ...
                (t.prototype.insertParagraph = function (t, e) {
                    ...
                    if (n) {
                        ...
                        if (
                            ...
                            (s = s.concat(
                                $t.listDescendant(o, $t.isEmptyAnchor),
                            )),
                                C.each(s, function (t, e) {
                                    $t.remove(e);
                                }),
                ...
                (t.prototype.addRow = function (t, e) {
                    ...
                    if ('top' === e) n.before(r);
                        ...
                        if (1 < o.rowSpan) {
                            ...
                            return void C(C(n).parent().find('tr')[h]).after(
                                C(r),
                            );
                        }
                        n.after(r);
                ...
                (this.insertParagraph = this.wrapCommand(function () {
                    ...
                    (this.insertText = this.wrapCommand(function (t) {
                        if (!u.isLimited(t.length)) {
                            var e = u
                                .getLastRange()
                                .insertNode($t.createText(t));
                            At.create(e, $t.nodeLength(e)).select(),
                                u.setLastRange();
                        }
                    })),
                    (this.pasteHTML = this.wrapCommand(function (t) {
                        if (!u.isLimited(t.length)) {
                            ...
                            At.createFromNodeAfter(B.last(e)).select(),
                                u.setLastRange();
                        }
                    })),
                    ...
                    (this.createLink = this.wrapCommand(function (t) {
                        ...
                        if (!(0 < r && u.isLimited(r))) {
                            ...
                            C.each(a, function (t, e) {
                                C(e).attr('href', o),
                                    n
                                        ? C(e).attr('target', '_blank')
                                        : C(e).removeAttr('target');
                            });
                            var c = At.createFromNodeBefore(
                                    B.head(a),
                                ).getStartPoint(),
                                d = At.createFromNodeAfter(
                                    B.last(a),
                                ).getEndPoint();
                            At.create(
                                c.node,
                    ...
                    return (
                        ...
                        (void 0 === e ||
                            !(
                                ...
                                e.metaKey ||
                                B.contains(
                                    [Pt.code.BACKSPACE, Pt.code.DELETE],
                                    e.keyCode,
                                )
                            )) &&
            ...
            return (
                ...
                (t.prototype.pasteByEvent = function (t) {
                    ...
                    if (e && e.items && e.items.length) {
                        var o =
                            1 < e.items.length ? e.items[1] : B.head(e.items);
                        'file' === o.kind &&
        ...
        ce = (function () {
            ...
            return (
                (t.prototype.shouldInitialize = function () {
                    return (
                        this.options.airMode &&
                        !B.isEmpty(this.options.popover.air)
                    );
                }),
                (t.prototype.initialize = function () {
                    this.$popover = this.ui
        ...
        de = (function () {
            ...
            return (
                ...
                (t.prototype.handleKeyup = function (t) {
                    ...
                    if (
                        !B.contains(
                            [Pt.code.ENTER, Pt.code.UP, Pt.code.DOWN],
                            t.keyCode,
                        )
                    ) {
                        var e = this.context
